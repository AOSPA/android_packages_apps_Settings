...
class ManageTargetAppFunctionAccessPreferenceControllerTest {
    ...
    private var controller: ManageTargetAppFunctionAccessPreferenceController? = null
    ...
    fun setUp() {
        ...
        appFunctionManagerWrapper.stub { onBlocking { isValidTarget(PACKAGE_NAME) }.doReturn(true) }
        ...
        controller = ManageTargetAppFunctionAccessPreferenceController(context, PREFERENCE_KEY)
    ...
    fun whenAppFunctionsEnabled_isInvalidTarget_thenPreferenceUnavailable() = runTest {
        appFunctionManagerWrapper.stub {
            onBlocking { isValidTarget(PACKAGE_NAME) }.doReturn(false)
        }

...
class InstallCertificateFromStorageScreenApiTest {
    private val tester = ApiTester(InstallCertificateFromStorageScreenApi())
    @get:Rule val setFlagsRule = SetFlagsRule()

    @Test
    @EnableFlags(FLAG_CATALYST_MIGRATION_26Q2)
    fun getScreenIsNotNull() {
        Truth.assertThat(tester.getScreen()).isNotNull()
    }

    @Test
    @DisableFlags(FLAG_CATALYST_MIGRATION_26Q2)
    fun getScreenFlagDisabledIsNull() {

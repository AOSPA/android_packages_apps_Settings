...
/** Tests for {@link TouchpadThreeFingerTapAppLaunchPreferenceController} */
@RunWith(RobolectricTestRunner.class)
@Config(shadows = {
        com.android.settings.testutils.shadow.ShadowInputDevice.class,
})
public class TouchpadThreeFingerTapAppLaunchPreferenceControllerTest {

    @Rule
    public final SetFlagsRule mSetFlagsRule = new SetFlagsRule();
    private static final String PREFERENCE_KEY = "preference_key";

    private TouchpadThreeFingerTapAppLaunchPreferenceController mController;

    @Before
    public void setup() {
        mController = new TouchpadThreeFingerTapAppLaunchPreferenceController(

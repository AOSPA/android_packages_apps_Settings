...
class TapScreenGestureApiScreenTest {
    @get:Rule val setFlagsRule = SetFlagsRule()

    private val tester = ApiTester(TapScreenGestureApiScreen())
    ...
    fun setUp() {
        ...
        SettingsShadowResources.overrideResource(
            R.array.config_dozeTapSensorPostureMapping,
            arrayOf("gesture1", "gesture2"),
        )
    }
    ...
    @Test
    fun getLaunchIntent_withTapScreenGesture_hasIntent() {
        assertThat(tester.getLaunchIntent()).isNotNull()
    }

    @Test
    fun getLaunchIntent_withoutTapScreenGesture_throwsHardwareUnsupportedException() {
        SettingsShadowResources.overrideResource(
            R.array.config_dozeTapSensorPostureMapping,
            emptyArray<String>(),
        )
    ...
    fun getMainSwitchPreference_defaultOn_returnTrue() {
        Settings.Secure.putInt(
            ...
            TapScreenGestureApiScreen.ON,
        )

        assertThat(tester.get<Boolean>(TapScreenGestureApiScreen.MAIN_SWITCH_KEY)).isTrue()
    }
    ...
    fun getMainSwitchPreference_defaultOff_returnFalse() {
        Settings.Secure.putInt(
            context.contentResolver,
            DOZE_TAP_SCREEN_GESTURE,
            TapScreenGestureApiScreen.OFF,
        )

        assertThat(tester.get<Boolean>(TapScreenGestureApiScreen.MAIN_SWITCH_KEY)).isFalse()
    }

    @Test
    fun getMainSwitchPreference_withoutTapScreenGesture_throwsHardwareUnsupportedException() {
        SettingsShadowResources.overrideResource(
            R.array.config_dozeTapSensorPostureMapping,
            emptyArray<String>(),
        )
        ...
        assertFailsWith<HardwareUnsupportedException> {
            tester.get<Boolean>(TapScreenGestureApiScreen.MAIN_SWITCH_KEY)
        }
    }

    @Test
    fun setMainSwitchPreference_asTrue_returnOn() {
        tester.set(TapScreenGestureApiScreen.MAIN_SWITCH_KEY, true)
        ...
        assertThat(
            ...
            .isEqualTo(TapScreenGestureApiScreen.ON)
    }

    @Test
    fun setMainSwitchPreference_asFalse_returnOff() {
        tester.set(TapScreenGestureApiScreen.MAIN_SWITCH_KEY, false)
        ...
        assertThat(
            ...
            .isEqualTo(TapScreenGestureApiScreen.OFF)
    }

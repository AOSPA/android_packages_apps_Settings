...
class SmartAutoRotateApiScreenTest {
    @get:Rule val setFlagsRule = SetFlagsRule()

    private val tester = ApiTester(SmartAutoRotateApiScreen())
...
// LINT.ThenChange(SmartAutoRotatePreferenceFragmentTest.java, SmartAutoRotatePreferenceControllerTest.java, SmartAutoRotateControllerTest.java)

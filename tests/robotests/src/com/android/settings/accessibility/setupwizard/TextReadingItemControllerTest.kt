...
/** Tests for [TextReadingItemController]. */
@RunWith(RobolectricTestRunner::class)
class TextReadingItemControllerTest {
    ...
    fun onItemSelected_navigatesToTextReadingSetupWizardFragment() {
        activityScenarioRule.scenario.onActivity { activity ->
            ...
            val controller = TextReadingItemController(mockItem)
            ...
            assertThat(currentFragment).isInstanceOf(TextReadingSetupWizardFragment::class.java)
        }
    }
}

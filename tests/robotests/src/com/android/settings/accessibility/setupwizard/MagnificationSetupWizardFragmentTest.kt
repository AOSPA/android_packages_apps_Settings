...
/** Tests for [MagnificationSetupWizardFragment]. */
@RunWith(RobolectricTestRunner::class)
class MagnificationSetupWizardFragmentTest {
        ...
        launchFragment().use { scenario ->
            scenario.onFragment { fragment ->
                val layout =
                    fragment
                        .requireView()
                        .findViewById<GlifRecyclerLayout>(R.id.magnification_suw_screen_layout)

                val headerText = layout.headerTextView.text
                assertThat(headerText)
                    .isEqualTo(
                        appContext.getString(R.string.accessibility_screen_magnification_title)
                    )

                val descriptionText = layout.descriptionTextView.text
                assertThat(descriptionText)
                    .isEqualTo(
                        appContext.getString(R.string.accessibility_screen_magnification_intro_text)
                    )
            }
        }
    }
        ...
        launchFragment().use { scenario ->
            scenario.onFragment { fragment ->
                val layout =
                    fragment
                        .requireView()
                        .findViewById<GlifLayout>(R.id.magnification_suw_screen_layout)
    ...
    private fun launchFragment(): FragmentScenario<MagnificationSetupWizardFragment> =
        launchFragmentInContainer<MagnificationSetupWizardFragment>(themeResId = R.style.GlifTheme)
}

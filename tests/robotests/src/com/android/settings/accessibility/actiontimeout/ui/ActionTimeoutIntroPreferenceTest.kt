...
class ActionTimeoutIntroPreferenceTest {
    private val context: Context = ApplicationProvider.getApplicationContext()
    private val preference = ActionTimeoutIntroPreference()

    @Test
    fun key_returnsCorrectKey() {
        assertThat(preference.key).isEqualTo(ActionTimeoutIntroPreference.KEY)
    }

    @Test
    fun title_returnsCorrectTitleRes() {
        assertThat(preference.title)
            .isEqualTo(R.string.accessibility_control_timeout_preference_intro_text)
    }
    ...
    fun purpose_returnsCorrectPurposeRes() {
        assertThat(preference.purpose).isEqualTo(R.string.a11y_action_timeout_top_intro_purpose)
    }
}

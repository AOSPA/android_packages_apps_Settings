...
/** Test for [FontSizeDelegate]. */
@RunWith(RobolectricTestRunner::class)
class FontSizeDelegateTest {

    private val context = ApplicationProvider.getApplicationContext<Context>()
    private val fontSizeDataStore = FontSizeDataStore(context)
    private val delegate = FontSizeDelegate(fontSizeDataStore, FontSizePreference.KEY)

    @Test
    fun fontSizePreview_initialValue_matchesDataStore() {
        val expectedData = fontSizeDataStore.fontSizeData.value

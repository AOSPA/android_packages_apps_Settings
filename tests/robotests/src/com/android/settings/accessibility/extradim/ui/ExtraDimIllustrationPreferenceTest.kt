...
class ExtraDimIllustrationPreferenceTest {
    private val context: Context = ApplicationProvider.getApplicationContext()
    private val preference = ExtraDimIllustrationPreference()

    @Test
    fun key() {
        assertThat(preference.key).isEqualTo(ExtraDimIllustrationPreference.KEY)
    }

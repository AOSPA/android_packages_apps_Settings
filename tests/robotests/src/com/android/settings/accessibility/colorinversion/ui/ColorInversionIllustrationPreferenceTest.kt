...
class ColorInversionIllustrationPreferenceTest {
    private val context: Context = ApplicationProvider.getApplicationContext()
    private val preference = ColorInversionIllustrationPreference()

    @Test
    fun key() {
        assertThat(preference.key).isEqualTo(ColorInversionIllustrationPreference.KEY)
    }
    ...
    fun getContentDescription() {
        val preferenceWidget = preference.createWidget(context)

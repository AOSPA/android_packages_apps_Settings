...
public class EnableWebAppMinterPreferenceControllerTest {
    ...
    @Mock private android.content.pm.webapp.WebAppManager mWebAppManager;
    ...
    public void setup() {
        ...
        when(mContext.getSystemService(android.content.pm.webapp.WebAppManager.class))
                .thenReturn(mWebAppManager);
        when(mWebAppManager.shouldShowDeveloperOption()).thenReturn(true);
    ...
    public void isAvailable_whenFlagEnabledButShouldNotShow_shouldReturnFalse() {
        mSetFlagsRule.enableFlags(com.android.webapp.flags.Flags.FLAG_ENABLE_WEB_APP_SERVICE_V2);
        when(mWebAppManager.shouldShowDeveloperOption()).thenReturn(false);
        assertThat(mController.isAvailable()).isFalse();
    }
    ...
    public void updateState_settingDisabled_preferenceShouldNotBeChecked() {
        Settings.Global.putInt(mContext.getContentResolver(),
                Settings.Global.ENABLE_WEBAPP_MINTER, SETTING_VALUE_OFF);
    ...
    public void updateState_settingEnabled_preferenceShouldBeChecked() {
        Settings.Global.putInt(mContext.getContentResolver(),
                Settings.Global.ENABLE_WEBAPP_MINTER, SETTING_VALUE_ON);
        mController.updateState(mPreference);

...
import static com.android.settings.development.bluetooth.MaxConnectedAudioDevicesPreferenceController.MAX_CONNECTED_AUDIO_DEVICES_PROPERTY;
...
public class MaxConnectedAudioDevicesPreferenceControllerTest {
    ...
    private MaxConnectedAudioDevicesPreferenceController mController;
    ...
    public void setup() {
        ...
        doReturn(TEST_MAX_CONNECTED_AUDIO_DEVICES)
                .when(mBluetoothAdapter)
                .getMaxConnectedAudioDevices();
        // Init the actual controller
        mController = new MaxConnectedAudioDevicesPreferenceController(mSpyContext);
    ...
    public void verifyResourceSizeAndRange() {
        ...
        final String defaultEntry =
                String.format(mListEntries[0].toString(), TEST_MAX_CONNECTED_AUDIO_DEVICES);
        ...
        assertThat(
                ...
                .isEqualTo(TEST_MAX_CONNECTED_AUDIO_DEVICES);
    }

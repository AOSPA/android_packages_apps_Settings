...
public class SnoopLogFilterProfilePbapPreferenceControllerTest {
    ...
    private SnoopLogFilterProfilePbapPreferenceController mController;
    ...
    public void setup() {
        ...
        mController = new SnoopLogFilterProfilePbapPreferenceController(mSpyContext);

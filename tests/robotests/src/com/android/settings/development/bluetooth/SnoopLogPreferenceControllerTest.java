...
import static com.android.settings.development.bluetooth.SnoopLogPreferenceController.BLUETOOTH_BTSNOOP_LOG_MODE_PROPERTY;
...
public class SnoopLogPreferenceControllerTest {
    ...
    private SnoopLogPreferenceController mController;
    ...
    public void setup() {
        ...
        mController = new SnoopLogPreferenceController(mSpyContext, null);

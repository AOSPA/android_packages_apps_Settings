...
public class SnoopLogFilterProfileMapPreferenceControllerTest {
    ...
    private SnoopLogFilterProfileMapPreferenceController mController;
    ...
    public void setup() {
        ...
        mController = new SnoopLogFilterProfileMapPreferenceController(mSpyContext);
    ...
    public void verifyResourceSizeAndRange() {
        Assert.assertTrue(
                SnoopLogFilterProfileMapPreferenceController.isSnoopLogModeFilteredEnabled());
    ...
    public void onPreferenceChanged_turnOnBluetoothSnoopLogFullFilterMap() {
        ...
        mController.onPreferenceChange(
                null,
                mListValues[
                        SnoopLogFilterProfileMapPreferenceController

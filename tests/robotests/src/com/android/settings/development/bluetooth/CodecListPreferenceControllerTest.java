...
public class CodecListPreferenceControllerTest {
    ...
    private CodecListPreferenceController mController;
    ...
    public void setup() {
        ...
        mController =
                new CodecListPreferenceController(
                        mContext, mLifecycle, mA2dpConfigStore, mCallback);

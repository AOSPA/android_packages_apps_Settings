...
/**
 * Shadow for {@link WifiDppUtils} to allow for testing WiFi sharing and Easy Connect logic.
 */
@Implements(WifiDppUtils.class)
public class ShadowWifiDppUtils {
     ...
     */
    @Implementation
    public static void showLockScreenForWifiSharing(Context context, Runnable callback) {
        sShowLockScreenCalled = true;
    }
    ...
    /**
     * Resets the state of the shadow between tests.
     */
    @Resetter
    public static void reset() {
        sShowLockScreenCalled = false;
    }
}

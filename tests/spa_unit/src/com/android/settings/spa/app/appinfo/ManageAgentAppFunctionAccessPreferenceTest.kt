...
class ManageAgentAppFunctionAccessPreferenceTest {
    ...
    fun setUp() {
        ...
        doReturn(listOf(PACKAGE_NAME)).whenever(appFunctionManager).validAgents
    ...
    fun content_display_flagDisabled() {
        ...
        composeTestRule
            .onNodeWithText(
                context.getString(R.string.manage_agent_app_function_access_settings_title)
            )
            .assertDoesNotExist()
        composeTestRule
            .onNodeWithText(
                context.getString(R.string.manage_agent_app_function_access_settings_summary)
            )
            .assertDoesNotExist()
    }

...
class RoamingPreference(
    ...
    private fun showDialog() {
        fragmentManager?.let { RoamingDialogFragment.newInstance(context.getString(title), RoamingDialogFragment.TYPE_ENABLE_DIALOG, subId, MobileNetworkSettings.isCiwlanModeSupported(subId)).show(it, DIALOG_TAG) }
    }

...
public class ButtonsSettings extends SettingsPreferenceFragment implements
    ...
    private void reload() {
        ...
        final boolean buttonVolumeRockerWakeEnabled = Settings.System.getIntForUser(resolver,
                Settings.System.VOLUME_ROCKER_WAKE_ENABLED, 0, UserHandle.USER_CURRENT) != 0;
        ...
        if (mmVolumeRockerWake != null) {
            mmVolumeRockerWake.setChecked(buttonVolumeRockerWakeEnabled);
        }

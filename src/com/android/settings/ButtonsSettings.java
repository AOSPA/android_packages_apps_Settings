...
public class ButtonsSettings extends SettingsPreferenceFragment implements
    ...
    private boolean handleOnPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        final boolean handled = handleOnPreferenceTreeClick(preferenceScreen, preference);

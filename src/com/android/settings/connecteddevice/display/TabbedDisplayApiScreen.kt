...
class TabbedDisplayApiScreen :
    PreferencesApiScreen(
        key = KEY,
        topLevelSettingsCategory = Category.CONNECTED_DEVICES,
        fragment = TabbedDisplayPreferenceFragment::class,
        purpose = R.string.external_display_screen_purpose,
    ) {
    ...
    init {
        ...
        parameters {
            parameter(
                ...
                required = true,
                type = DisplayId(allowInternal = true, allowExternal = true),
            )
            ...
            prepareScreenExtras { params, extras ->
                ...
                extras.putInt(ExternalDisplaySettingsConfiguration.DISPLAY_ID_ARG, paramId)
            }
        }
        ...
        preconditions(R.string.external_display_connected_preconditions) {
            ...
            val hasExternalDisplay =
                displayManager?.displays?.any { display ->
                    displayInjector.isConnectedDisplay(display)
                } ?: false
    ...
    companion object {
        const val KEY = "external_display_screen"
    }
}
// LINT.ThenChange(TabbedDisplayPreferenceFragment.kt)

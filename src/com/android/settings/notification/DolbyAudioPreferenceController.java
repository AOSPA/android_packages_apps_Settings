...
public class DolbyAudioPreferenceController extends SettingPrefController {
    ...
    public boolean isAvailable() {
        ...
        final boolean supportsDolbyAudio = res.getBoolean(com.android.internal.R.bool.device_supports_dolby_audio);
        final String targetPackage = res.getString(com.android.internal.R.string.dolby_targetPackage);
        final String targetClass = res.getString(com.android.internal.R.string.dolby_targetClass);

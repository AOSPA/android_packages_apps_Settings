...
public class ZenModeSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private SwitchPreference mInterruptionsAsHeadsUp;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mInterruptionsAsHeadsUp = (SwitchPreference) root
                .findPreference(KEY_HEADS_UP_TOGGLE);
        mInterruptionsAsHeadsUp.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            @Override
    ...
    private void updateControls() {
        ...
        refreshAutomationSection();
        updateEndSummary();
        mInterruptionsAsHeadsUp.setChecked(getHeadsUpInterruptionsState());
    }

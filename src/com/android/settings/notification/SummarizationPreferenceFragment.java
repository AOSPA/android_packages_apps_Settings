...
public class SummarizationPreferenceFragment extends DashboardFragment {
    ...
    private static final String SUMMARIZATION_CATEGORY_KEY = "enabled_settings";
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        ...
        controllers.add(
                new SummarizationCombinedPreferenceController(context, SUMMARIZATION_CATEGORY_KEY,

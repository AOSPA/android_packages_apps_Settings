...
public class VibrationIntensityDialog extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (mIsRinger) {
            ...
            sb.setMin(1);
            sb.setMax(3);
            mProgress = Settings.System.getIntForUser(contentResolver, HAPTIC_FEEDBACK_INTENSITY, 2, UserHandle.USER_CURRENT);
            sb.setProgress(mProgress);
            setText(txtView, mPreference, mProgress);
        ...
        sb.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                Settings.System.putIntForUser(contentResolver, mIsRinger ? RING_VIBRATION_INTENSITY : mIsNotif ? 

...
public class VibrationIntensityDialog extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (mIsRinger) {
            ...
            sb.setMax(3);
            mProgress = Settings.System.getInt(contentResolver,
                    NOTIFICATION_VIBRATION_INTENSITY, 2);
            sb.setProgress(mProgress);
            setText(txtView, mPreference, mProgress);
            ...
            sb.setMax(3);
            mProgress = (Settings.System.getInt(contentResolver,
                    HAPTIC_FEEDBACK_ENABLED, 0) == 0) ? 0 : Settings.System.
                    getInt(contentResolver, HAPTIC_FEEDBACK_INTENSITY, 2);
            sb.setProgress(mProgress);
            setText(txtView, mPreference, mProgress);
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                if (!mIsRinger && !mIsNotif) {
                    Settings.System.putInt(contentResolver,
                                HAPTIC_FEEDBACK_ENABLED, Math.min(mProgress, 1));
                }

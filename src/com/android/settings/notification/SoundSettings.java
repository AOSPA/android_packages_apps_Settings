...
public class SoundSettings extends DashboardFragment implements OnActivityResultListener {
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        final DolbyAudioPreferenceController dolbyAudioPreferenceController =
                new DolbyAudioPreferenceController(context, fragment, lifecycle);
        ...
        controllers.add(dolbyAudioPreferenceController);
        controllers.add(new PreferenceCategoryController(context,
                ...
                Arrays.asList(dialPadTonePreferenceController,
                        ...
                        dolbyAudioPreferenceController)));

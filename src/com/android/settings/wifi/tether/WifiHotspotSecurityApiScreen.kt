...
// LINT.IfChange
@ProvidePreferenceScreen(WifiHotspotSecurityApiScreen.KEY)
class WifiHotspotSecurityApiScreen :
    ...
    companion object {
        const val KEY = "wifi_hotspot_security"
    }
}
// LINT.ThenChange(WifiHotspotSecuritySettings.java)

...
public class DashboardAdapter extends RecyclerView.Adapter<DashboardAdapter.DashboardItemHolder>
    ...
    public void onBindViewHolder(DashboardItemHolder holder, int position) {
        switch (mTypes.get(position)) {
            ...
            case R.layout.suggestion_tile:
                ...
                if (mThemeEnabled) {
                    holder.itemView.getBackground().setColorFilter(mAccentColor, Mode.SRC_ATOP);
            ...
            case R.layout.condition_card:
                ConditionAdapterUtils.bindViews((Condition) mItems.get(position), holder,
                        mItems.get(position) == mExpandedCondition, mThemeEnabled, mAccentColor,
    ...
    private void onBindSuggestionHeader(final DashboardItemHolder holder) {
        ...
        if (mThemeEnabled) {
            holder.itemView.getBackground().setColorFilter(mAccentColor, Mode.SRC_ATOP);
            holder.icon.setColorFilter(Color.BLACK, Mode.SRC_ATOP);

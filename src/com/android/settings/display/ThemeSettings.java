...
public class ThemeSettings extends PreviewSeekBarPreferenceFragment implements Indexable {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mThemeEnabled = Settings.Secure.getInt(getContentResolver(),
                Settings.Secure.THEME_PRIMARY_COLOR, 0) == 1;
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, 0, 0, R.string.theme_switch_palette)
                .setIcon(mThemeEnabled ? R.drawable.switch_colors_dark
                        : R.drawable.switch_colors)

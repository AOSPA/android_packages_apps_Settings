...
public class ScreenOffUdfpsPreferenceController extends TogglePreferenceController {
    ...
    private static final String TAG = "ScreenOffUdfpsPrefCtr";
    ...
    public boolean isChecked() {
        final float isScreenOffUdfpsEnabled =
                Settings.Secure.getInt(
                        mContext.getContentResolver(),
                        Settings.Secure.SCREEN_OFF_UDFPS_ENABLED, 1);
    ...
    public boolean setChecked(boolean isChecked) {
        return Settings.Secure.putInt(
                mContext.getContentResolver(), Settings.Secure.SCREEN_OFF_UDFPS_ENABLED, isChecked ? 1 : 0);
    }

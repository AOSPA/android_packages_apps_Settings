...
public class DarkUIAddonPreferenceController extends AbstractPreferenceController
    ...
    @VisibleForTesting
    DarkUIAddonPreferenceController(Context context, PackageManager packageManager,
    ...
    public DarkUIAddonPreferenceController(Context context, String category) {

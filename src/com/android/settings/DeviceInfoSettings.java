...
import com.android.settings.deviceinfo.ParanoidAndroidDevicePreferenceController;
import com.android.settings.deviceinfo.ParanoidAndroidVersionPreferenceController;
...
public class DeviceInfoSettings extends DashboardFragment implements Indexable {
    ...
    private static List<PreferenceController> buildPreferenceControllers(Context context,
        ...
        controllers.add(new ParanoidAndroidVersionPreferenceController(context));
        controllers.add(new SecurityPatchPreferenceController(context));
        controllers.add(new FccEquipmentIdPreferenceController(context));
        controllers.add(new SELinuxStatusPreferenceController(context));
        controllers.add(new SafetyInfoPreferenceController(context));

        ParanoidAndroidDevicePreferenceController mParanoidAndroidDevicePreferenceController = new ParanoidAndroidDevicePreferenceController(context);
        if (mParanoidAndroidDevicePreferenceController.isAvailable()) {
            controllers.add(mParanoidAndroidDevicePreferenceController);
        } else {

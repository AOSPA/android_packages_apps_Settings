...
public class TotalRAMPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return mContext.getResources().getBoolean(R.bool.config_show_device_model) ? AVAILABLE
    ...
    @Override
    public void copy() {
        Sliceable.setCopyContent(mContext, getSummary(), mContext.getText(R.string.total_ram));
    }

    @Override
    public CharSequence getSummary() {
        ActivityManager actManager = (ActivityManager) mContext.getSystemService(

...
public class BatteryTemperaturePreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        final int temperatureTenths = batteryIntent.getIntExtra(BatteryManager.EXTRA_TEMPERATURE, -1);

        if (temperatureTenths != -1) {
            float temperature = temperatureTenths / 10f;
            return mContext.getString(R.string.battery_temperature_summary, temperature);
        }

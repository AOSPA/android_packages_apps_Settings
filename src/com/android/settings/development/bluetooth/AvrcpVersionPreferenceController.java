...
public class AvrcpVersionPreferenceController extends DeveloperOptionsPreferenceController
    ...
    public AvrcpVersionPreferenceController(Context context) {
        super(context);
    ...
    public void updateState(Preference preference) {
        ...
        int index = 3; // Defaults to AVRCP 1.6

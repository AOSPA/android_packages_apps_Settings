...
public class SnoopLogFilterProfilePbapPreferenceController
        extends DeveloperOptionsPreferenceController
        implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin {

    private static final String TAG = "SnoopLogFilterProfilePbapPreferenceController";
    ...
    public SnoopLogFilterProfilePbapPreferenceController(Context context) {
        super(context);
        mListValues =

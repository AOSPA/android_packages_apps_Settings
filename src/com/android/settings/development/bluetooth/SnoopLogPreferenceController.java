...
public class SnoopLogPreferenceController extends DeveloperOptionsPreferenceController
...
// QTI_END: 2019-10-18: Bluetooth: Change order of BT snoop dev UI options[1/2]
    ...
    public SnoopLogPreferenceController(Context context, @Nullable SnoopLogHost host) {
        ...
        mListEnhancedValues = Arrays.asList(context.getResources().getStringArray(
                com.android.settingslib.R.array.bt_hci_snoop_log_values_enhanced));
        mHost = host;
    }

 ...
 */
public class BluetoothSnoopLogSocketPreferenceController extends
    ...
    @VisibleForTesting
    static final String BLUETOOTH_SNOOP_LOG_SOCKET_PROPERTY =
            "persist.bluetooth.btsnoopsocket.enabled";

    public BluetoothSnoopLogSocketPreferenceController(Context context) {
        super(context);
    }

    @Override
    public String getPreferenceKey() {
        return BLUETOOTH_SNOOP_LOG_SOCKET_KEY;
    }
    ...
    protected void onDeveloperOptionsSwitchDisabled() {
        ...
        SystemProperties.set(BLUETOOTH_SNOOP_LOG_SOCKET_PROPERTY, "false");

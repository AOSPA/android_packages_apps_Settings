...
/**
 * A preference item for sending feedback specifically for hearing devices.
 *
 * This class extends [FeedbackButtonPreference] then sets the feedback page ID based on the type of
 * hearing aid that was most recently used (ASHA or LE Audio).
 */

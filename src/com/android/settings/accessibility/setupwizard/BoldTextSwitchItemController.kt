...
/** Controller for the bold text switch item in the Accessibility Setup Wizard. */
class BoldTextSwitchItemController(
    ...
    override fun onStart() {
        ...
        boldTextDataStore.addObserver(BoldTextPreference.KEY, observer, context.mainExecutor)
    }

    override fun onStop() {
        boldTextObserver?.let {
            boldTextDataStore.removeObserver(BoldTextPreference.KEY, it)
            boldTextObserver = null
        }
    }
    ...
    private fun updateDataStore(value: Boolean) {
        boldTextDataStore.setBoolean(BoldTextPreference.KEY, value)
    }
}

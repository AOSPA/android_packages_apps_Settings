...
class ActionTimeoutFooterPreference :
    ...
    override val title: Int
        get() = R.string.accessibility_control_timeout_preference_summary
    ...
    override val helpResource: Int
        get() = R.string.help_url_timeout

    override val learnMoreText: Int
        get() = R.string.accessibility_control_timeout_footer_learn_more_content_description

    companion object {
        const val KEY = "accessibility_control_timeout_footer"
    }
}

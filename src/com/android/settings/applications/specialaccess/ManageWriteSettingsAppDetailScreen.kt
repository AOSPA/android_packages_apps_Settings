...
open class ManageWriteSettingsAppDetailScreen : SpecialAccessAppDetailScreen {
    ...
    override val purpose: Int
        get() = R.string.special_access_manage_write_settings_app_detail_purpose
    ...
    companion object :
        ...
        fun keyParameters(context: Context, showSystemApp: Boolean) =
            keyParameters(context, showSystemApp, ::manageWriteSettingsFilter)

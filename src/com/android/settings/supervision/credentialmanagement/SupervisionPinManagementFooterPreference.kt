...
/** A bottom banner on PIN management screen. */
class SupervisionPinManagementFooterPreference : FooterPreferenceMetadata, FooterPreferenceBinding {
    ...
    override fun bind(preference: Preference, metadata: PreferenceMetadata) {
        ...
        footerPreference.setLearnMoreAction { onLearnMore(preference.context) }
    }

    fun onLearnMore(context: Context) {
        val intent =
            HelpUtils.getHelpIntent(
                context,
                context.getString(R.string.supervision_pin_learn_more_link),
    ...
    companion object {
        const val KEY = "pin_management_footer"
    }
}

 ...
 */
public class AdaptivePlaybackPreferenceController extends AbstractPreferenceController implements
        PreferenceControllerMixin, LifecycleObserver, RadioButtonPreference.OnClickListener {

    private static final String TAG = "AdaptivePlaybackPreferenceController";
    ...
    public AdaptivePlaybackPreferenceController(Context context, Lifecycle lifecycle,
    ...
    public void onRadioButtonClicked(RadioButtonPreference preference) {
        ...
        Settings.System.putIntForUser(mContentResolver, ADAPTIVE_PLAYBACK_TIMEOUT, value,
    ...
    public void updateState(Preference preference) {
        ...
        int timeoutValue = Settings.System.getIntForUser(mContentResolver,
    ...
    public void setPreferenceEnabled(boolean enabled) {
        Log.d(TAG, "setEnabled:" + String.valueOf(enabled));

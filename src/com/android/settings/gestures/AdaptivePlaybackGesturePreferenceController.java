...
public class AdaptivePlaybackGesturePreferenceController extends AbstractPreferenceController
    ...
    public void onRadioButtonClicked(RadioButtonPreference preference) {
        ...
        if (adaptivePlaybackTimeout != Settings.System.getInt(mContext.getContentResolver(),
    ...
    public void updateState(Preference preference) {
        int adaptivePlayback = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.ADAPTIVE_PLAYBACK_ENABLED, 0);
        int adaptivePlaybackTimeout = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.ADAPTIVE_PLAYBACK_TIMEOUT, ADAPTIVE_PLAYBACK_TIMEOUT_30_SECS);
        final boolean isTimeout30Sec = adaptivePlaybackTimeout == ADAPTIVE_PLAYBACK_TIMEOUT_30_SECS;
        final boolean isTimeout1Min = adaptivePlaybackTimeout == ADAPTIVE_PLAYBACK_TIMEOUT_1_MIN;
        final boolean isTimeout2Min = adaptivePlaybackTimeout == ADAPTIVE_PLAYBACK_TIMEOUT_2_MIN;
        final boolean isTimeout5Min = adaptivePlaybackTimeout == ADAPTIVE_PLAYBACK_TIMEOUT_5_MIN;
        final boolean isTimeout10Min = adaptivePlaybackTimeout == ADAPTIVE_PLAYBACK_TIMEOUT_10_MIN;

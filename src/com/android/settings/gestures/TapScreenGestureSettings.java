...
import co.aospa.settings.gestures.TapScreenGestureInsidePreferenceController;
...
public class TapScreenGestureSettings extends DashboardFragment {
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        controllers.add(new TapScreenGestureInsidePreferenceController(context));
        return controllers;
    }
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.tap_screen_gesture_settings_doze;
    }

    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.tap_screen_gesture_settings_doze);
}

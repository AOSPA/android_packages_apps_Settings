...
public class PowerButtonTorchGesturePreferenceController extends GesturePreferenceController {
    ...
    public boolean setChecked(boolean isChecked) {
        return Settings.Secure.putInt(mContext.getContentResolver(), TORCH_POWER_BUTTON_GESTURE,
                isChecked ? ON : OFF);
    }

    @Override
    public boolean isChecked() {
        return Settings.Secure.getInt(mContext.getContentResolver(), TORCH_POWER_BUTTON_GESTURE, 0) != 0;
    }
}

...
public class AdaptivePlaybackSettings extends DashboardFragment
        ...
        AdaptivePlaybackSwitchPreferenceController.OnSwitchChangeListener {

    private static final String TAG = "AdaptivePlaybackSettings";

    private static AdaptivePlaybackSwitchPreferenceController mSwitchController;
    ...
    public void onSwitchChanged(boolean isChecked) {
        Log.d(TAG, "onSwitchChanged:" + String.valueOf(isChecked));
        for (AdaptivePlaybackPreferenceController controller : sTimeoutControllers) {
            controller.setPreferenceEnabled(isChecked);
        }
    }
    ...
    public void onResume() {
        ...
        for (AbstractPreferenceController controller :
            ...
            } else if (controller instanceof AdaptivePlaybackSwitchPreferenceController) {
                Log.d(TAG, "setOnSwitchChangeListener");
                ((AdaptivePlaybackSwitchPreferenceController) controller).setOnSwitchChangeListener(this);
            }
        }
    ...
    public void onPause() {
        ...
        for (AbstractPreferenceController controller :
            ...
            if (controller instanceof AdaptivePlaybackPreferenceController) {
                ...
                Log.d(TAG, "setOnSwitchChangeListener: null");
                ((AdaptivePlaybackSwitchPreferenceController) controller).setOnSwitchChangeListener(null);
            }
        }
    }
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        preferenceControllers
                .add(new AdaptivePlaybackSwitchPreferenceController(context, lifecycle));

...
public class AdaptivePlaybackSettings extends DashboardFragment
        implements AdaptivePlaybackController.OnChangeListener {
    ...
    public void onResume() {
        ...
        for (AbstractPreferenceController controller :
            ...
            ((AdaptivePlaybackController) controller).setOnChangeListener(this);
        }
    }
    ...
    public void onPause() {
        ...
        for (AbstractPreferenceController controller :
                buildPreferenceControllers(getPrefContext(), getSettingsLifecycle())) {
            ((AdaptivePlaybackController) controller).setOnChangeListener(null);
        }
    }
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        if (sControllers.size() == 0) {
            ...
            for (int i=0; i < timeoutKeys.length; i++) {
                sControllers.add(new AdaptivePlaybackController(

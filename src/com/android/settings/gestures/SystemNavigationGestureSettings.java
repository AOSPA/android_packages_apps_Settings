...
public class SystemNavigationGestureSettings extends RadioButtonPickerFragment implements
    ...
    static void migrateOverlaySensitivityToSettings(Context context,
        ...
        boolean immnav = Settings.Secure.getInt(context.getContentResolver(),
                Settings.Secure.IMMERSIVE_NAVIGATION, 1) == 1;
        try {
            info = overlayManager.getOverlayInfo(immnav ? NAV_MODE_IMMERSIVE_OVERLAY :
        ...
        if (info != null && !info.isEnabled()) {
            ...
            setCurrentSystemNavigationMode(overlayManager, KEY_SYSTEM_NAV_GESTURAL, immnav);
    ...
    @VisibleForTesting
    static void setCurrentSystemNavigationMode(IOverlayManager overlayManager, String key, boolean immnav) {
        String overlayPackage = NAV_BAR_MODE_GESTURAL_OVERLAY;
        switch (key) {
            case KEY_SYSTEM_NAV_GESTURAL:
                overlayPackage = immnav ? NAV_MODE_IMMERSIVE_OVERLAY : NAV_BAR_MODE_GESTURAL_OVERLAY;
                break;

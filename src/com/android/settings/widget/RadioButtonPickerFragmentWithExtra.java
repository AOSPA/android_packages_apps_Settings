...
public abstract class RadioButtonPickerFragmentWithExtra extends InstrumentedPreferenceFragment implements
        RadioButtonPreference.OnClickListener {

    @VisibleForTesting
    static final String EXTRA_FOR_WORK = "for_work";
    private static final String TAG = "RadioButtonPckrFrgmtWithExtra";
    @VisibleForTesting
    boolean mAppendStaticPreferences = false;

    private final Map<String, CandidateInfoExtra> mCandidates = new ArrayMap<>();
    ...
    protected CandidateInfoExtra getCandidate(String key) {
    ...
    public void bindPreferenceExtra(RadioButtonPreference pref,
            String key, CandidateInfoExtra info, String defaultKey, String systemDefaultKey) {
    }

    @VisibleForTesting
    public void updateCandidates() {
        mCandidates.clear();
        final List<? extends CandidateInfoExtra> candidateList = getCandidates();
        if (candidateList != null) {
            for (CandidateInfoExtra info : candidateList) {
    ...
    public RadioButtonPreference bindPreference(RadioButtonPreference pref,
            String key, CandidateInfoExtra info, String defaultKey) {
    ...
    protected abstract List<? extends CandidateInfoExtra> getCandidates();

...
public class Omni_Helpers implements Constants {

    private static final String TAG = "Omni_Helpers";
    ...
    public static int getNumOfCpus() {
        int numOfCpu = 1;
        String numOfCpus = Omni_Helpers.readOneLine(NUM_OF_CPUS_PATH);
...
*/
    ...
    public static void get_assetsScript(String fn, Context c, String prefix, String postfix) {
        ...
        try {
            ...
            sb.insert(0, "#!" + Omni_Helpers.binExist("sh") + "\n\n");
            try {

...
public class SeekBarPreferenceChOS extends Preference implements OnSeekBarChangeListener {
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        final TypedArray typedArray = getContext().obtainStyledAttributes(
                      attrs, R.styleable.SeekBarPreferenceChOS);
        ...
        Integer id = typedArray.getResourceId(R.styleable.SeekBarPreferenceChOS_unitsRight, 0);
        if (id > 0) {
            mUnitsRight = getContext().getResources().getString(id);
        }
        id = typedArray.getResourceId(R.styleable.SeekBarPreferenceChOS_unitsLeft, 0);
        if (id > 0) {

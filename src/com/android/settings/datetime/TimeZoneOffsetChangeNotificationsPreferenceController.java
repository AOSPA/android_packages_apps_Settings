...
import com.android.settings.datetime.NotificationsPreferenceCategoryController;
...
public class TimeZoneOffsetChangeNotificationsPreferenceController
        extends TogglePreferenceController
        implements LifecycleObserver, OnStart, OnStop, TimeManager.TimeZoneDetectorListener {

    private static final String TAG = "TimeZoneOffsetChangeNotificationsSettings";
    ...
    public TimeZoneOffsetChangeNotificationsPreferenceController(@NonNull Context context,
            @NonNull String key) {
        super(context, key);
    ...
    public boolean isChecked() {
        ...
        return configuration.areTimeZoneOffsetChangeNotificationsEnabled();
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        TimeZoneConfiguration configuration = new TimeZoneConfiguration.Builder()
                .setTimeZoneOffsetChangeNotificationsEnabled(isChecked)
                .build();

...
public class FaceEnrollIntroduction extends BiometricEnrollIntroduction {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utils.isExtFaceServiceAvailable() && mHasPassword && mToken != null) {
            startExtFaceEnroll();
        }
    }
    ...
    private void startExtFaceEnroll() {
        Intent intent = new Intent();
        intent.putExtra(ChooseLockSettingsHelper.EXTRA_KEY_CHALLENGE_TOKEN, mToken);
        if (mUserId != UserHandle.USER_NULL) {
            intent.putExtra(Intent.EXTRA_USER_ID, mUserId);
        }
        intent.setComponent(new ComponentName("com.paranoid.facelock", "com.paranoid.facelock.activities.SetupFaceIntroActivity"));

...
public class ParanoidFaceSettings extends DashboardFragment implements 
    ...
    private Preference mKeyguardPref;
    ...
    public boolean isAvailable() {
        return mSenseConnector.isParanoidFaceSenseEnabled();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRemoveButton = findPreference(KEY_REMOVE_FACE);
        mRemoveButton.setOnClickListener(this);
        mEnrollButton = findPreference(KEY_ENROLL_FACE);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mKeyguardPref) {
            ...
            Settings.Secure.putInt(getContext().getContentResolver(),
                    FACE_UNLOCK_DISMISSES_KEYGUARD, mBypassPref.isChecked ? 1 : 0, UserHandle.USER_CURRENT);
        }
        updatePrefs();
    }

...
@SearchIndexable
class AccountSecuritySubpageFragment : DashboardFragment() {
    ...
    override fun getPreferenceScreenResId(): Int {
        return R.xml.safety_center_account_security_subpage
    }
    ...
    override fun createPreferenceControllers(context: Context): List<AbstractPreferenceController> {
        ...
        safetyIssuesPreferenceController =
            SafetyIssuesPreferenceController(context, ACCOUNT_SECURITY_ISSUES_KEY)
    ...
    private fun setupIllustration() {
        ...
        illustrationPreference.imageDrawable =
            context?.getDrawable(R.drawable.safety_center_account_security_subpage_illustration)
    }
    ...
    companion object {
        private const val TAG = "AccountSecuritySubpage"

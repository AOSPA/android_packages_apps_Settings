 ...
 */
@SearchIndexable
class CellularNetworkSecuritySubpageFragment : SafetyCenterSubpageFragment() {

    override val subpageKey = SafetyCenterSubpageRegistry.CELLULAR_NETWORK_SECURITY_SUBPAGE_KEY

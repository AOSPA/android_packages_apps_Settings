...
class DeviceFindersSubpageFragment : DashboardFragment() {
    ...
    var safetySourceIds: List<String> = emptyList()
    ...
    override fun createPreferenceControllers(context: Context): List<AbstractPreferenceController> =
        listOf(SafetyIssuesPreferenceController(context, DEVICE_FINDERS_ISSUES_KEY))
    ...
    private fun setupSafetyIssuesPreferenceController(
        ...
        safetyIssuesPreferenceController.apply {
            viewModel = this@DeviceFindersSubpageFragment.viewModel

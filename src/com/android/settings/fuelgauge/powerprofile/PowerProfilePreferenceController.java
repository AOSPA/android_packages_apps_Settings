...
public class PowerProfilePreferenceController extends BasePreferenceController
    ...
    static final String KEY_POWER_PROFILE_ENABLED = "power_profile_enabled";
    static final String KEY_POWER_PROFILE_SELECTED = "power_profile_selected";
    ...
    private static final int PROFILE_POWERSAVER = 0;
    ...
    public void updateState(Preference preference) {
        final boolean isProfilePowerSaver = mPowerProfileEnabled
                && mPowerProfileSelected == PROFILE_POWERSAVER;

...
public class PowerUsageSummary extends PowerUsageBase implements
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        batteryStyle.add(1, SUBMENU_BATTERY_BAR, 1, R.string.battery_style_portrait)
        ...
        switch (item.getItemId()) {
            ...
            case SUBMENU_BATTERY_BAR:
                ...
                Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUS_BAR_BATTERY_STYLE, 0);
                getPreferenceScreen().findPreference(KEY_BATTERY_PERCENTAGE_SUMMARY)
                        .setEnabled(true);
                return true;
            ...
            case SUBMENU_BATTERY_HIDDEN:
                item.setChecked(true);
                Settings.Secure.putInt(getActivity().getContentResolver(),
                    Settings.Secure.STATUS_BAR_BATTERY_STYLE, 3);
                getPreferenceScreen().findPreference(KEY_BATTERY_PERCENTAGE_SUMMARY)
                        .setEnabled(false);
                return true;
            default:

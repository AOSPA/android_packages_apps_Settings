...
public class PowerUsageSummary extends PreferenceFragment {
    ...
    private static final int SUBMENU_BATTERY_BAR_LANDSCAPE  = Menu.FIRST + 4;
    private static final int SUBMENU_BATTERY_CIRCLE         = Menu.FIRST + 5;
    private static final int SUBMENU_BATTERY_TEXT           = Menu.FIRST + 6;
    private static final int SUBMENU_BATTERY_HIDDEN         = Menu.FIRST + 7;
    private static final int MENU_BATTERY_PERCENT           = Menu.FIRST + 8;
    private static final int SUBMENU_BATTERY_PERCENT_HIDDEN = Menu.FIRST + 9;
    private static final int SUBMENU_BATTERY_PERCENT_INSIDE = Menu.FIRST + 10;
    private static final int SUBMENU_BATTERY_PERCENT_NEXT   = Menu.FIRST + 11;
    private static final int MENU_BATTERY_SAVER             = Menu.FIRST + 12;

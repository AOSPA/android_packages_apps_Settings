...
public class PowerUsageSummary extends PreferenceFragment {
    ...
    private static final int SUBMENU_BATTERY_BAR_PERCENT    = Menu.FIRST + 5;
    private static final int SUBMENU_BATTERY_CIRCLE         = Menu.FIRST + 6;
    private static final int SUBMENU_BATTERY_CIRCLE_PERCENT = Menu.FIRST + 7;
    private static final int SUBMENU_WARNING_POPSOUND       = Menu.FIRST + 8;
    private static final int SUBMENU_WARNING_NOTIFSOUND     = Menu.FIRST + 9;
    private static final int SUBMENU_WARNING_POPUPDIALOG    = Menu.FIRST + 10;
    private static final int SUBMENU_WARNING_NOTIF          = Menu.FIRST + 11;
    private static final int SUBMENU_WARNING_SOUND          = Menu.FIRST + 12;

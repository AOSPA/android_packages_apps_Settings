...
class BatteryPercentageController extends AbstractPreferenceController implements
    ...
    private boolean isTextOrHiddenStyleEnabled;
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        isTextOrHiddenStyleEnabled = Settings.Secure.getInt(mContext.getContentResolver(),
                Settings.Secure.STATUS_BAR_BATTERY_STYLE, 0) == 2 ||
                Settings.Secure.getInt(mContext.getContentResolver(),
                        Settings.Secure.STATUS_BAR_BATTERY_STYLE, 0) == 3;
        screen.findPreference(KEY_BATTERY_PERCENTAGE)
                .setEnabled(!isTextOrHiddenStyleEnabled);
    }

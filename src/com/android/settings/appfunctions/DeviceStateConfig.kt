...
fun getScreenConfigs() =
    listOf(
        PerScreenConfig(enabled = true, screenKey = DarkModeScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = ColorAndMotionScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = AdaptiveConnectivityScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = "adaptive_vibration_settings_page"),
        PerScreenConfig(enabled = true, screenKey = AutoBrightnessScreen.KEY),
        PerScreenConfig(
            enabled = true,
            screenKey = BatterySaverScreen.KEY,
            category = setOf(DeviceStateCategory.BATTERY),
        ),
        PerScreenConfig(enabled = true, screenKey = BluetoothDashboardScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = LockScreenPreferenceScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = "touch_sensitivity_settings_page"),
        PerScreenConfig(enabled = true, screenKey = DisplayScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = FirmwareVersionScreen.KEY),
        PerScreenConfig(
            enabled = true,
            screenKey = NetworkProviderScreen.KEY,
            category = setOf(DeviceStateCategory.MOBILE_DATA),
        ),
        PerScreenConfig(enabled = false, screenKey = LanguageSettingScreen.KEY),
        PerScreenConfig(enabled = false, screenKey = ModuleLicensesScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = LegalSettingsScreen.KEY),
        PerScreenConfig(
            enabled = true,
        ...
        PerScreenConfig(enabled = true, screenKey = MyDeviceInfoScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = DataSaverScreen.KEY),
        PerScreenConfig(
            enabled = true,
        ...
        PerScreenConfig(enabled = true, screenKey = "reverse_charging"),
        PerScreenConfig(enabled = true, screenKey = ScreenTimeoutScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = SoundScreen.KEY),
        PerScreenConfig(enabled = false, screenKey = SupervisionPinManagementScreen.KEY),
        PerScreenConfig(
            enabled = true,
            screenKey = TetherScreen.KEY,
            category = setOf(DeviceStateCategory.MOBILE_DATA),
        ),
        PerScreenConfig(enabled = false, screenKey = SupervisionDashboardScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = VibrationIntensityScreen.KEY),
        PerScreenConfig(enabled = true, screenKey = VibrationScreen.KEY),
        PerScreenConfig(
            enabled = true,

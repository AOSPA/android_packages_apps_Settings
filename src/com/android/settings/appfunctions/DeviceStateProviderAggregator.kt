 ...
 */
@Keep
class DeviceStateProviderAggregator(private val executors: List<DeviceStateExecutor>) :
    ...
    override suspend fun aggregate(
        ...
        val executorResults = coroutineScope {
            executors
                .map { executor ->
                    async { executor.execute(appFunctionType) as DeviceStateProviderExecutorResult }
                }
                .map { it.await() }
        }
        ...
        return DeviceStateResponse(perScreenDeviceStates = allStates, deviceLocale = deviceLocale)
    }
}
 ...
 */
@Keep
data class DeviceStateProviderExecutorResult(

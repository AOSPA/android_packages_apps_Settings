...
class MediaRoutingControlApiScreen :
    PreferencesApiScreen(
        ...
        spaRoutePrefix = MediaRoutingControlAppListProvider.getAppListRoute(),
        purpose = R.string.special_access_media_routing_control_list_purpose,
    ) {
    init {
    ...
    companion object {
        const val KEY = "media_routing_control"
    }
}
